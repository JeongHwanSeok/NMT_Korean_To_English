...
def get_args():
    ...
    # 3. Eecoder
    parser.add_argument('--encoder_rnn_dim', default=400, type=int)
    ...
    parser.add_argument('--encoder_output_transformer', default=400)
    parser.add_argument('--encoder_output_transformer_bias', default=True, type=bool)
    parser.add_argument('--encoder_hidden_transformer', default=400)
    parser.add_argument('--encoder_hidden_transformer_bias', default=True, type=bool)

    # 4. Decoder
    parser.add_argument('--decoder_rnn_dim', default=400, type=int)
    ...
    parser.add_argument('--get_beam_search', default=True, type=bool)
    parser.add_argument('--beam_search_k', default=3, type=bool)
