...
def get_args():
    ...
    parser.add_argument('--encoder_embedding_dropout', default=0.2, type=float)
    parser.add_argument('--encoder_rnn_dropout', default=0.2, type=float)
    ...
    # dropout : drop하는 노드의 비율
    parser.add_argument('--decoder_embedding_dropout', default=0.2, type=float)
    parser.add_argument('--decoder_dropout', default=0.2, type=float)
    parser.add_argument('--decoder_rnn_dropout', default=0.2, type=float)
