import argparse
from Customize_Seq2SeqWithAttention.tools import Trainer
...
def get_args():
    ...
    parser.add_argument('--encoder_residual_used', default=False, type=bool)
    ...
    # 5. Attention
    parser.add_argument('--attention_score', default='dot', type=str, choices=['dot', 'general'])
